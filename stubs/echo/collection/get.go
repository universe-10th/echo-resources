...
func get[IDT comparable, RT types.Resource[IDT]](
	...
	_, element, err := retrieveScopedElement(engine, context, deleted)
	if err != nil {
		return err
	}
...
// GetEndpointStub implements a stub that provides an echo endpoint based
// on an implementation engine.
